.var title_screen_new = 1		//New title screen enabled / Disable hi-score saver <-- DO NOT CHANGE
...
//--------------------------------------------------------------------------------
				...
				*=$0400 "ONE TIME CODE + OPTIONAL STATUS PANEL CHARSET"
				
				
				//IF USING THIS FRAMEWORK VERSION - DISABLE THE HI SCORE LOADER
				//IN onetime.asm
...
//--------------------------------------------------------------------------
				...
				*=$0900 "S.E.U.C.K GAME DATA SEGMENT 1"
				
				//Insert SEUCK finished game data from $0900-$6580				
				.import c64 "c64/seuckdata1.prg" //	<--- FILENAME FOR SEUCK GAME $0900-$6580
...
//FILE / EXPORT / CHARSET - export the charset to the folder C64  
				...
				*=$7000 "TITLE SCREEN CHARACTER SET"				
charsetdata:	.import binary "c64\front_end_charset.bin" //<--- FILENAME FOR FRONT END TEXT CHARSET					
...
//===========================================================================										
				...
				*=$7800 "TITLE SCREEN CODE"

				//If using this source. You must DISABLE LoadHiScores 
				//in onetime.asm
								
				#import "titlescreen2.asm" 			


//If you want to use the multi-colour bitmap logo for your own
//title screen. Then please enable the following below. Otherwise
//leave it all commented out.


				*=$8000 "TITLE SCREEN LOGO COLOUR RAM DATA"
logocoldata:					
				.import c64 "c64/logocolram.prg"	//    <--- FILENAME FOR LOGO PICTURE COLOUR RAM
				
				*=$8400 "TITLE SCREEN LOGO VIDEO RAM DATA + END SCREEN, TITLE SCREEN AND CHARSET COLOUR DATA"
logoviddata:				
				.import c64 "c64/logovidram.prg"	//	<--- FILENAME FOR LOGO PICTURE VIDEO RAM 
...
//VERY IMPORTANT:
//---------------
//If you are using the new title screen (Multi-colour bitmap 
//logo. Add // by the next routine below to disable hiscore table
//and disk saver. The front end which consists of the multi-colour
//bitmap will not allow displaying high score tables
...
endscreendata:	.import binary "c64\end_screen.bin" // <--- FILENAME FOR END SCREEN, SCREEN

				//Insert your front end screen data 
											
screendata:		.import binary "c64\front_end_screenv2.bin"		//<--- FILENAME FOR FRONT END	SCREEN
//----------------------------------------------------------------------
//In charpad:
...
screenattribs:	.import binary "c64\front_end_attribs.bin" // <--- FILENAME FOR FRONT END/END CHAR COLOURS
...
// sidrelec -p $90 titlemusic.sid relocmusic.sid
			...
			*=$9000	"TITLE SCREEN MUSIC"
			.import c64 "c64\titlemusic.prg"	// <--- FILENAME FOR TITLE MUSIC ($9000-$a000)
			
//------------------------------------------------------------------------ 
		
			*=$A000 "TITLE SCREEN LOGO BITMAP DATA + SCROLL TEXT"
			
			//Insert title screen logo multicolour bitmap data 
			//(Important, bitmap size must be only $1000 bytes)
			//or install in game music... [Use Buzzsaw Logo Cutting Machine 
			//on supplied disk]
			
			.import c64 "c64\logobitmap.prg" // <--- FILENAME FOR LOGO PICTURE BITMAP DATA
...
//-------------------------------------------------------------------------				
 			...
 			*=$b6c0 "S.E.U.C.K GAME DATA SEGMENT 2 ($B6C0-$FFFA)"
